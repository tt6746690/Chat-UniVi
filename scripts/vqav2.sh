...
python -m ChatUniVi.eval.convert_vqav2_for_submission --src "$output_file" --dst $SAVE_DIR/$SPLIT/answers_upload.json --test_split $EVAL_DATA_DIR/llava_vqav2_mscoco_test2015.jsonl
