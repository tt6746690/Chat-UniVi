...
from ChatUniVi.mm_utils import tokenizer_image_token, process_images, get_model_name_from_path
...
def eval_model(args):
    ...
    for i, line in enumerate(tqdm(questions)):
        ...
        if 'image' in line:
            ...
            # wpq: not using pad/anyres, so just resize to square.
            # ref: https://github.com/haotian-liu/LLaVA/blob/main/llava/mm_utils.py
